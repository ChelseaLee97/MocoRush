...
const addressByChainId: { [chainId: number]: Address } = {
  31337: (import.meta.env.VITE_MOCORUSH_ADDRESS_LOCAL as Address) ?? NULL_ADDRESS, // local hardhat
  11155111: (import.meta.env.VITE_MOCORUSH_ADDRESS_SEPOLIA as Address) ?? '0x2da021bd370019f6ed6f447698f78e989ba2dd37', // sepolia
};
