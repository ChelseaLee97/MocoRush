...
export const win95Theme = {
  ...
  '--ck-connectbutton-background': win95Background,
  '--ck-connectbutton-box-shadow': buttonBoxShadow,
  '--ck-connectbutton-border-radius': '0px',

  '--ck-connectbutton-hover-color': '#000',
  '--ck-connectbutton-hover-background': win95Background,

  '--ck-connectbutton-active-background': win95Background,
  ...
  '--ck-body-background': win95Background,
  ...
  // Primary button
  '--ck-primary-button-color': '#000',
  '--ck-primary-button-background': win95Background,
  '--ck-primary-button-box-shadow': buttonBoxShadow,
  '--ck-primary-button-active-border-radius': '0px',
  '--ck-primary-button-border-radius': '0',

  // Primary button hover
  '--ck-primary-button-hover-background': win95Background,
  '--ck-primary-button-hover-box-shadow': buttonBoxShadow,
  '--ck-primary-button-hover-border-radius': '0px',

  // Modal
  '--ck-modal-heading-font-weight': 400,
  '--ck-modal-box-shadow': `inset 1px 1px 0px 1px #ffffff, inset 0 0 0 1px #868a8e, 1px 1px 0 1px #000000`,
  '--ck-modal-h1-font-weight': 400,

  // Secondary button
  '--ck-secondary-button-color': '#373737',
  '--ck-secondary-button-border-radius': '0px',
  '--ck-secondary-button-box-shadow': buttonBoxShadow,
  '--ck-secondary-button-background': '#c3c7cb',

  // Secondary button hover
  '--ck-secondary-button-hover-background': win95Background,
  '--ck-secondary-button-hover-box-shadow': buttonBoxShadow,
